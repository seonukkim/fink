...
_PATHWAY_ACTIONS: dict[PathwayLabel, RecommendedAction] = {
    PathwayLabel.CLARIFICATION_LIKELY_SUFFICIENT: RecommendedAction(
        ...
        action_ko="권장: 몇 가지 항목을 확인한 뒤 서명을 검토하세요.",
        action_en="Recommendation: clarify a few items, then consider signing.",
    ...
    PathwayLabel.NEGOTIATION_REQUIRED: RecommendedAction(
        ...
        action_ko="권장: 서명 전에 핵심 조건을 재협상하세요.",
        action_en="Recommendation: renegotiate the key terms before signing.",
    ...
    PathwayLabel.PROFESSIONAL_REVIEW_REQUIRED: RecommendedAction(
        ...
        action_ko="권장: 서명 전에 전문가 검토를 받는 것을 권합니다.",
        action_en="Recommendation: seek a professional review before signing.",
    ...
    PathwayLabel.DISPUTE_PATHWAY_MAY_BE_REQUIRED: RecommendedAction(
        ...
        action_ko="권장: 미지급 또는 지연 항목을 먼저 정리하고 대응하세요.",
        action_en="Recommendation: address the unpaid or delayed items first.",
