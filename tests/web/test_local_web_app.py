...
class WebSmokeTests(unittest.TestCase):
    ...
    def test_app_js_route_and_analyze_endpoint_are_local_only(self) -> None:
        ...
        self.assertIn(b'data-copy-review-brief', body)
    ...
    def test_app_js_invalid_stored_locale_falls_back_to_ko(self) -> None:
        ...
        self.assertIn("function copyReviewBrief(button)", script)
        self.assertIn("function downloadReviewBrief(button)", script)
        self.assertIn("function writeClipboardText(value, done)", script)
