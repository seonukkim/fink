...
class WebSmokeTests(unittest.TestCase):
    ...
    def test_app_js_invalid_stored_locale_falls_back_to_ko(self) -> None:
        ...
        self.assertIn("var pair = clauseReferencePair(record.finding, record.originalIndex);", script)
        self.assertIn('wrap.appendChild(bilingual("span", "finding-line-clause", pair));', script)
