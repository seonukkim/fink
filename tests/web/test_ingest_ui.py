...
class IngestUITests(unittest.TestCase):
    def test_ui_ingest_tests_all_modes_are_reachable_in_phone_and_desktop_ui(self) -> None:
        ...
        self.assertIn('data-ui-ingest-modes="camera image pdf paste"', markup)
        self.assertIn('data-ingest-mode="camera"', markup)
        self.assertIn('capture="environment"', markup)
        self.assertIn('data-ingest-mode="image"', markup)
        self.assertIn('accept="image/png,image/jpeg,image/webp,image/heic,image/heif"', markup)
        self.assertIn('data-ingest-mode="pdf"', markup)
        self.assertIn('accept="application/pdf,.pdf"', markup)
        self.assertIn('data-ingest-mode="paste"', markup)
        self.assertIn('data-layout="mobile"', markup)
        self.assertIn('data-layout="desktop"', markup)
