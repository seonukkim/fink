...
questions for review. It is not a legal, validity, fraud, unfairness, or
guaranteed-loss verdict.

Accessible description for the paper and project page:

- EN: FInk highlights creator-contract wording that may affect cash flow,
...
`CLM-S7-MAP-DISCUSSION`. Measured result highlights are intentionally deferred
to `06_results.md`, where each value cites a `CLAIM_LEDGER.csv` row backed by a
measured `RESULT_LEDGER.csv` row.
